...
const config: Config = {
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/qiniu/techcamp/tree/main/website/',
        },
        blog: {
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} 七牛云 1024 TechCamp. Built with Docusaurus.`,
    },
    prism: {
